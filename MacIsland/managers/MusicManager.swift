...
class MusicManager: ObservableObject {
    ...
    @Published var songTitle: String = "Nothing Playing"
    @Published var artistName: String = "Start audio in a supported app"
    ...
    private var lastArtworkTitle: String = "Nothing Playing"
    private var lastArtworkArtist: String = "Start audio in a supported app"
    ...
    private func setActiveControllerBasedOnPreference() {
        ...
        if let controller = createController(for: controllerType) {
            ...
            mediaFallbackMessage = "\(controllerType.rawValue) unavailable; using Apple Music."
            setActiveController(fallbackController)
        } else {
            mediaFallbackMessage = "No supported media source is available."
        }
    }
    ...
    private func setActiveController(_ controller: any MediaControllerProtocol) {
        ...
        activeMediaSource = (controller as? NowPlayingController) != nil ? .nowPlaying
            : (controller as? AppleMusicController) != nil ? .appleMusic
            : (controller as? SpotifyController) != nil ? .spotify
            : .youtubeMusic
