...
class SettingsWindowController: NSWindowController {
    ...
    private func setupWindow() {
        ...
        window.title = "MacIsland Settings"
        ...
        // A menu-bar utility must not reopen Settings on launch because it was
        // visible in a previous session.
        window.isRestorable = false
        window.identifier = NSUserInterfaceItemIdentifier("MacIslandSettingsWindow")
