//
//  MacIslandXPCHelperProtocol.swift
//  MacIslandXPCHelper
//
...
@objc protocol MacIslandXPCHelperProtocol {
...
/*
 To use the service from an application or other process, use NSXPCConnection to establish a connection to the service by doing something like this:
     ...
     connectionToService = NSXPCConnection(serviceName: "com.macisland.app.MacIslandXPCHelper")
     connectionToService.remoteObjectInterface = NSXPCInterface(with: (any MacIslandXPCHelperProtocol).self)
     connectionToService.resume()

 Once you have a connection to the service, you can use it like this:

     if let proxy = connectionToService.remoteObjectProxy as? MacIslandXPCHelperProtocol {
